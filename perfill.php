...
<button class="custom-button"> <a href='presencaaluno.php?aluno=<?php echo $linha[0];?>&MOD1=<?php echo "$MOD1"; ?>&MOD2=<?php echo "$MOD2"; ?>'>Histórico de Frequência</a></button>
        </div>
        <div class="column2">
            <h2>Características Físicas</h2>
            <label>Altura: <?php echo " $linha[8]"; ?> </label>
            <label>Peso: <?php echo " $linha[9]"; ?></label>
            <label><?php $altura= $linha[8]/100; $IMC= $linha[9]/($altura*$altura);echo 'IMC: '; echo round($IMC,1);?></label><br><br>

                <h2>Nota Particular</h2>
                <label>Nota: <?php echo "$linha[10]"; ?></label><br>
          <!-- Botão "Ver meu histórico de frequência" -->
             <button class="custom-button"><a href='editar.php?aluno1=<?php echo $linha[0];?>&MOD1=<?php echo "$MOD1"; ?>&MOD2=<?php echo "$MOD2"; ?>'>Alterar Perfil e Nota Particular</a></button>
        </div>
    </div>
</body>
</html>